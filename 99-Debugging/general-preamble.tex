...
\usepackage{alltt}
\usepackage{graphicx}
%\usepackage{xcolor} % xcolor is an enhanced version of color -- Opened in myMemoir
\usepackage{latexsym}
\usepackage{amsmath}
\usepackage{fontenc}
\usepackage{pifont}
...
%https://latex.org/forum/viewtopic.php?t=27722
%http://www.bakoma-tex.com/doc/latex/base/utf8ienc.pdf
...
%\ExecuteBibliographyOptions{doi=only,bookpages=false,isbn=false,bookseries=false,compresspages} % Keep getting error message saying bookseries is undefined!
